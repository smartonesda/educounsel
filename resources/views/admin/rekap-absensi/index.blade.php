...
<div class="p-6 pt-20">
    ...
    <div class="mb-6">
        ...
        <form method="GET" action="{{ route('admin.rekap-absensi') }}" class="flex flex-col sm:flex-row gap-4">
            <!-- Search -->
            ...
            @if(request('search') || request('kelas_id'))
                <a href="{{ route('admin.rekap-absensi') }}" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-all">
                    ...
                    @forelse($siswaList as $index => $siswa)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-3 px-4 text-center">
                                <a href="{{ route('admin.detail-absensi', $siswa->id) }}" 

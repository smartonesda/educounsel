    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            <div class="top-bar-left">
                ...
                <div class="user-info">
                    ...
                    <div class="user-details">
                        <h3>{{ auth()->user()->nama ?? auth()->user()->name }}</h3>
                        <p>Siswa</p>
                    </div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('logout') }}" class="m-0">
                @csrf
                <button type="submit" style="background:#fee2e2;color:#ef4444;border:none;padding:8px 16px;border-radius:8px;font-weight:600;cursor:pointer;display:flex;align-items:center;">
                    🚪 Keluar
                </button>
            </form>
        </div>
